...
# EMVA1288 parameters
path = os.getcwd()
filename = "EMVA1288_Data_light_temporal.txt"
...
for i in range(exposure_step, exposure_max, exposure_step):
    ...
    if (int(i / 1000) < 10):
        write_file(path, filename, "i Images\\b_00" + str(int(i / 1000)) + "_snap_000.tif")
        write_file(path, filename, "i Images\\b_00" + str(int(i / 1000)) + "_snap_001.tif")
        take_image("b_00{}_snap_000".format(int(i / 1000)) + ".raw")
        print("saved image: b_00{}_snap_000.raw".format(int(i / 1000)))
        take_image("b_00{}_snap_001".format(int(i / 1000)) + ".raw")
        print("saved image: b_00{}_snap_001.raw".format(int(i / 1000)))
    else:
        write_file(path, filename, "i Images\\b_0" + str(int(i / 1000)) + "_snap_000.tif")
        write_file(path, filename, "i Images\\b_0" + str(int(i / 1000)) + "_snap_001.tif")
        take_image("b_0{}_snap_000".format(int(i / 1000)) + ".raw")
        print("saved image: b_0{}_snap_000.raw".format(int(i / 1000)))
        take_image("b_0{}_snap_001".format(int(i / 1000)) + ".raw")
        print("saved image: b_0{}_snap_001.raw".format(int(i / 1000)))
